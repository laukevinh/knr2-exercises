...
/* KnR Exercise 04-09   Our getch and ungetch do not handle
    a pushed-back EOF correctly. Decide what their properties
    ought to be if an EOF is pushed back, then implement 
    your design.

    Really not sure where the problem is, so I skipped this
    one. */
